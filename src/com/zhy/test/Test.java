...
public class Test
{
	 ...
	 * @throws IOException
	 */
	public void uploadFromBySocket(Map < String , String > params , String fileFormName , File uploadFile , String newFileName , String urlStr ) throws IOException
	{
		if(newFileName == null || newFileName.trim().equals(""))
		{
			newFileName = uploadFile.getName();
	...
	public static void main(String [] args )
	{
		try
		{
			...
			new Test().uploadForm(null ,"uploadFile" ,file ,"helloworld.txt" ,"http://localhost:8080/strurts2fileupload/uploadAction");

			new Test().uploadFromBySocket(null ,"uploadFile" ,file ,"hibernate-configuration-3.0.dtd" ,"http://localhost:8080/strurts2fileupload/uploadAction");
